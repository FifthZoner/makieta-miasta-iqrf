...
par1        EQU   0x73
  ...
  ; FILE C:\customdpa\CustomDpaHandlerExample\..\Include\IQRF.h
                        ;// *********************************************************************
...
main
  ...
  ; FILE C:\customdpa\CustomDpaHandlerExample\..\Include\IQRF-functions.h
                        ;// *********************************************************************
                        ;//                         IQRF OS functions                           *
                        ;// *********************************************************************
                        ;//
...
setServiceChannel
  ...
  ; FILE C:\customdpa\CustomDpaHandlerExample\..\Include\DPA.h
                        ;// *********************************************************************
  ...
  ; FILE C:\customdpa\CustomDpaHandlerExample\..\Include\DPAcustomHandler.h
                        ;// *********************************************************************
...
DpaApiEntry
  ...
  ; FILE C:\customdpa\CustomDpaHandlerExample\CustomDpaHandler-UserPeripheral-ADC.c
                        ;// **************************************************************************
                        ;//   Custom DPA Handler code example - User peripheral implementation - ADC *
                        ;// **************************************************************************
                        ;// Copyright (c) MICRORISC s.r.o.
                        ;//
                        ;// File:    $RCSfile: CustomDpaHandler-UserPeripheral-ADC.c,v $
                        ;// Version: $Revision: 1.36 $
                        ;// Date:    $Date: 2022/02/25 09:41:25 $
                        ;//
                        ;// Revision history:
                        ;//   2022/02/24  Release for DPA 4.17
                        ;//   2017/03/13  Release for DPA 3.00
                        ...
                        ;// Online DPA documentation https://doc.iqrf.org/DpaTechGuide/
                        ;
                        ;// This example implements the user peripherals ADC
                        ;// PNUM = 0x20 and PCMD = 0 returns 2 bytes with 10b ADC result from pin C5 at PData
                        ;// PNUM = 0x21 and PCMD = 0 returns 2 bytes with 10b ADC result from pin C1 at PData
                        ;// Works with TR-72 having connected pins RA.5, RC.6 and RB.4
                        ;// At DDC-SE-01 allows to read:
                        ;// * Light intensity measurement using a photoresistor
...
m009    MOVLB 0x0F
        BCF   0x798,ADCMD
                        ;
                        ;          // Might not be needed if ADC registers are kept default
                        ;          {
                        ;            // Start reseting ADC registers from ADCON0 to ADPCH
                        ;            // VREF- is connected to AVSS, VREF+ is connected to VDD
                        ;            FSR0 = &ADCON0;
        MOVLW 0x93
        MOVWF FSR0
        CLRF  FSR0+1
...
m010    MOVLW 0x00
        CALL  setINDF0
                        ;              FSR0++;
        ADDFSR INDF0,1
                        ;              // Stop reseting at 1st GPR register, ADPCH is the last implemented register before GPR
                        ;            } while ( !FSR0L.5 );
        BTFSS FSR0L,5
        BRA   m010
                        ;          }
        ...
        BRA   m011
                        ;          {
                        ;#if defined( TR7xG )
                        ;            //  ADC Positive Input Channel = ANA5
                        ;            setADPCH( 0x05 );
        MOVLW 0x9E
        MOVWF FSR0
        CLRF  FSR0+1
        ...
        CALL  setINDF0
                        ...
                        ;            ADCON0 = 0b0.00100.01;
                        ;#endif
                        ;            // ADC initialization (for more info see PIC datasheet) pin C5 (AN4-D/ANA5-G) as analog input
                        ;            ANSELA.5 = 1;
        MOVLB 0x3E
        BSF   ANSELA,5
                        ;          }
        ...
        BRA   m012
                        ;          {
                        ;#if defined( TR7xG )
                        ;            //  ADC Positive Input Channel = ANA0
                        ;            setADPCH( 0x00 );
m011    MOVLW 0x9E
        MOVWF FSR0
        CLRF  FSR0+1
        ...
        CALL  setINDF0
                        ...
                        ;            ADCON0 = 0b0.00000.01;
                        ;#endif
                        ;            // ADC initialization (for more info see PIC datasheet) pin C1 (AN0-D/ANA0-G) as analog input
                        ;            ANSELA.0 = 1;
        MOVLB 0x3E
        BSF   ANSELA,0
                        ;          }
                        ;
                        ;#if defined( TR7xG )
                        ;          // ADC is enabled, ADGO is cleared upon completion, Clock supplied according to ADCLK register, right-justified
                        ;          ADCON0 = 0b1000.0100;
m012    MOVLW 0x84
        MOVLB 0x01
        MOVWF ADCON0
...
; 0x3A20 P7  147 word(s)  7 % : CustomDpaHandler
